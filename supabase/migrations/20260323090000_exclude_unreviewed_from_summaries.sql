-- Exclude unreviewed transactions from monthly summary calculations.
-- Transactions with needs_review = true have not been categorized/verified
-- and should not count toward spending totals or budget tracking.
...
BEGIN
  ...
  -- ========================================
  -- Transaction aggregates (only reviewed transactions)
  -- ========================================
  ...
  -- Spending: need + want categories, excluding goal-linked and unreviewed transactions
  SELECT
  ...
  -- Transaction count (non-transfer, reviewed only)
  SELECT COUNT(*)
  ...
  -- ========================================
  -- Upsert monthly_category_summaries (reviewed transactions only)
  -- ========================================
